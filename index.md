...
<div class="hero-unit announcement">
  <h3> CMIP3 UPDATES</h3>
  <p>
  CMIP commiunity, for the first time ESGF is glad to announce that CMIP3 data can be downloaded from <a href="https://pcmdi.llnl.gov/projects/esgf-llnl/">pcmdi.llnl.gov</a>.
  </p>
</div>
